"""
Optimized & Scalable Metabase Question Fetcher
===============================================
A single-file Python script to fetch complete data from a Metabase saved question
using a highly optimized parallel pagination method. This version authenticates only
...
def fetch_question_data(
    ...
    password: str, 
    team: str = "growth",
    workers: int = 8,  # CHANGED: Added parameter for tuning
    page_size: int = 50000 # CHANGED: Added parameter for tuning
