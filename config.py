"""Central configuration for the Map Dashboard application.

This module collects credentials and other tunable constants in one
place so scripts can import settings without relying on environment
variables.
"""
